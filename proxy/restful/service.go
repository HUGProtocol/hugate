...
func (c *Service) Start() error {
	...
	go func() {
		muxWithMiddlewares := http.TimeoutHandler(r, time.Second*120, "Timeout!")
		server := &http.Server{Addr: address, Handler: muxWithMiddlewares, ReadTimeout: 120 * time.Second,
